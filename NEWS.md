...
* Better model definition for the `estimate_k_1RM_` family of functions. Now `1RM` parameter is estimated rather than `0RM`, which makes `get_predicted_1RM_from_k_model()` function obsolete
