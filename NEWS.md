...
* Added `estimate_` family of functions to estimate Epley's and modified Epley's equation parameters, as well as novel estimation functions that uses absolute weight to estimate both `k` parameter and 1RM
