...
[Strength Training Manual](https://amzn.to/3owbBr6) comes with two progression table implemented in `progression_RIR_increment()` and `progression_perc_drop()` functions, although there are other variants (and you can easily make your own). 
