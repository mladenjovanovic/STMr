...
Set accumulation function is very flexible. For example, here we can use `vertical_set_accumulation_reverse()` to create a neat accumulation-intensification progression:
